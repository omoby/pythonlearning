...
#点评首页
from DPCrawler.config import TAG_CHANGED, COMMENT_TAGS, COOKIE

HOST = 'http://m.dianping.com'

#各类请求URL
API_MODULE_PREV = 'https://m.dianping.com/{cityEnName}/ch{categoryId}/r{regionId}'
API_MODULE = 'https://m.dianping.com/isoapi/module'
