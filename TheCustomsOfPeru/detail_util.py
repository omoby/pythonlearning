...
# user_agent, g_proxy = ip_pool.get_agent_proxies()
# g_proxy = {'https': '1.194.145.184:43264', 'http': '1.194.145.184:43264'}
headers = {
...
def get_buscarPartida(url, code):
    ...
    headers[
        'Referer'] = f'http://www.aduanet.gob.pe/itarancel/arancelS01Alias?accion=buscarPartida&esframe=1&cod_partida={cod_partida}'

    try:
        response = requests.request("GET", real_url, headers=headers)
