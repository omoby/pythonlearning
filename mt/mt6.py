...
class OracleUtil():
    ...
    def get_url(self):
        ...
        # 数据库操作
        # 1.查询
        sql = "select ID_SEQ, TASK_URL from o1255_task_url_202004 where ID_SEQ NOT IN (select ID_SEQ FROM MT_MALL_DETAIL_202004) AND ID_SEQ > 101000 and ID_SEQ <=110000"
